...
[SYMB] = LAYOUT( \
    ...
    M(PSCREEN_APP), KC_PERC,    KC_CIRC, KC_LCBR, KC_RCBR, KC_TILD,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______, \
    KC_PSCR,        _______,    _______, _______, _______, _______,  _______, _______, _______, _______, _______, TO(GAME) \
),
...
[GAME] =  LAYOUT( \
    ...
    _______, _______, _______, _______, KC_SPC,  KC_ENT,     _______, _______, _______, _______, _______, TO(BASE) \
)
