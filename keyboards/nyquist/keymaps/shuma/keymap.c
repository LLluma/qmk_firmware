 ...
 * |------+------+------+------+------+------+   +-----+------+------+------+------+------|
 * | Ctrl | GUI  |  Alt | CAPS |Lwr/VM| Bksp |   |Spc  | Ent  | Lock |   =  |  Alt | Del  |
 * `-----------------------------------------'   `----------------------------------------'
 */
[BASE] = LAYOUT( \
    ...
    KC_LCTL,       KC_LGUI,      KC_LALT,   KC_CAPS, TD(TD_SYM_VIM), KC_BSPC, KC_SPC,  KC_ENT,  KC_LOCK, KC_EQL, KC_RALT,         KC_DEL \
),
...
[SYMB] = LAYOUT( \
    ...
    _______,        KC_HASH, KC_DLR,  KC_LCBR, KC_RCBR, KC_GRV,   KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT, KC_RCBR, KC_PIPE, \
