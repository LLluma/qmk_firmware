 ...
 * |------+------+------+------+------+------+   +-----+------+------+------+------+------|
 * | Ctrl |  Alt | CAPS | Bksp |  GUI |Lwr/VM|   | Spc | Ent  | Esc  |   =  |  Alt | Del  |
 * `-----------------------------------------'   `----------------------------------------'
 */
[BASE] = LAYOUT( \
    ...
    OSM(MOD_LSFT), KC_Z,    KC_X,      KC_C,    KC_V,     KC_B,           KC_N,    KC_M,    KC_COMM, KC_DOT, RCTL_T(KC_SLSH), OSM(MOD_RSFT), \
    KC_LCTL,       KC_LALT, KC_CAPS,   KC_BSPC, KC_LGUI,  TD(TD_SYM_VIM), KC_SPC,  KC_ENT,  KC_ESC,  KC_EQL, KC_RALT,         KC_DEL \
),
 ...
 * |      |      |      | LSHFT|      |      |  |      |  7   |  8   |  9   |  *   |      |
 * |------+------+------+------+------+------+  +------+------+------+------+------+------|
 * |      | DLeft|DRight| LCTRL| LGUI |      |  | Tab  |  4   |  5   |  6   |  +   |      |
 * |------+------+------+------+------+------+  +------+------+------+------+------+------|
 * |      |      |      |      |      |      |  | Ent  |  1   |  2   |  3   |  /   |      |
 * |------+------+------+------+------+------+  +------+------+------+------+------+------|
 * |      |      |      |      |      |      |  | Spc  |  0   |  .   |  =   |      |      |
...
[VIM] =  LAYOUT( \
    ...
    _______, _______,  _______,   KC_LSFT, _______, _______, _______, KC_7,    KC_8,    KC_9,    KC_ASTR, _______, \
    _______, M(DLEFT), M(DRIGHT), KC_LCTL, KC_LGUI, _______, KC_TAB,  KC_4,    KC_5,    KC_6,    KC_PLUS, _______, \
    _______, _______,  _______,   _______, _______, _______, KC_ENT,  KC_1,    KC_2,    KC_3,    KC_BSLS, _______, \
    _______, _______,  _______,   _______, _______, _______, KC_SPC,  KC_0,    KC_DOT,  KC_EQL,  _______, _______ \
),
